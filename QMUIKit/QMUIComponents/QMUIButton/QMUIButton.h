 ...
 *  @warning 不支持传 nil
 */
@property(nonatomic, strong)  UIColor *tintColorAdjustsTitleAndImage;
...
@property(nonatomic, assign)  CGFloat cornerRadius UI_APPEARANCE_SELECTOR;// 默认为 0。将其设置为 QMUIButtonCornerRadiusAdjustsBounds 可自动保持圆角为按钮高度的一半。
